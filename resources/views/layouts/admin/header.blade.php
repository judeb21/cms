<header class="app-header navbar">
        <div class="navbar-brand">
            <a class="" href="index.html">
                <img src="{{ asset ('admin/assets/img/dodo-logo.png') }}" srcset="assets/img/dodo-logo.png 2x" alt="">
            </a>
        </div>
        ...
        <ul class="nav navbar-nav ml-auto" style="margin-right: 50px;">
            ...
            <!--<li class="nav-item dropdown dropdown-slide d-md-down-none">
                <a class="nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                    <i class="ti-bell"></i>
                    <span class="badge badge-danger notification-alarm"> 6  </span>
                </a>
            ...
            <li class="nav-item dropdown dropdown-slide">
                <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                    <!--<img src="/admin/avatars/{{Auth::user()->Adminimage}}" alt="">-->
                    {{Auth::user()->name}}
                </a>
                <div class="dropdown-menu dropdown-menu-right dropdown-menu-accout">
                    <div class="dropdown-header pb-3">
                        <div class="media d-user">
                            <img class="align-self-center mr-3" src="/admin/avatars/{{Auth::user()->Adminimage}}" alt="{{Auth::user()->name}}">
